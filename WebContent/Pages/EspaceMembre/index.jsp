...
<head>
    ...
    <title>Serie Show Espace Membre</title>
    <!--titre de l onglet-->
        ...
        <form action="Enregistrement" method="POST">
            <div class="division">
                ...
                <fieldset>
                    <p>
                        ...
                        <input type="text" name="name" id="name-0" class="user" minlength="3" maxlength="30" pattern="^[a-zA-Z][a-z]{2,29}$"
                            title="Votre nom d'utlisateur sans chifffe" placeholder="Name"  />
                    </p>
                    <span id="missingNom"></span>

                    <p>
                        <label for="email-0">E-mail</label>
                        <input type="email" id="email-0" name="email" class="Email" placeholder="abc@xxx.com" 
                    ...
                    <p>
                        ...
                        <input type="password" name="passwordm" id="password-1" class="Password" minlength="8" maxlength="250"
                            title="Votre mot de passe min 8 caractères" placeholder="Password" 
                            tabindex="1" />
                    </p>
                    <span id="mdpdif"></span>
                    ...
                    <p>
                        ...
                        <input type="password" name="passwordc" id="password-2" class="Password" minlength="8" maxlength="250"
                            title="Votre mot de passe min 8 caractères" placeholder="Password" 
                            tabindex="1" />
                    </p>
                    <span id="mdpdif"></span>
                ...
                <fieldset class="submit">
                    <p>
                        <input type="submit" value="Modifier mon compte" id="bouton_envoi" />
                    </p>
                </fieldset>
