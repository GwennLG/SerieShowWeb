	...
	<section class="articles">
		<article class="card">
			...
			<div class="card_body">
				...
				<p class="card_description">Apr�s un mois d'arr�t et un �pisode
					� la fois altant et d�primant, Shawn est de retour sur vos �crans.
					Le dernier �pisode vous a laiss� dans l'attente supr�me. Comment
